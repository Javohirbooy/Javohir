  ...
  return (
    <div
      className={cn(
        ...
        "dark:border-slate-600/50 dark:from-slate-900/85 dark:via-slate-900/70 dark:to-slate-900/85 dark:shadow-[0_20px_50px_-24px_rgba(0,0,0,0.5),inset_0_1px_0_0_rgba(255,255,255,0.04)]",
